<x-layouts.app title="Home" meta-description="Home meta description">
    ...
    <form class="max-w-xl px-8 py-4 mx-auto bg-white rounded shadow dark:bg-withe" action="{{ route('register') }}"
        method="POST">
        @csrf

        <div class="space-y-4">
            <label class="flex flex-col">
                <span class="font-serif text-slate-600 dark:text-slate-800">Name</span>
                <input
            ...
            <label class="flex flex-col">
                <span class="font-serif text-slate-600 dark:text-slate-800">Email</span>
                <input
                    class="rounded-md shadow-sm border-slate-300 dark:bg-withe text-slate-600 dark:text-slate-400 focus:ring focus:ring-slate-300 dark:focus:ring-slate-800 focus:ring-opacity-50 dark:focus:border-slate-700 focus:border-slate-300 dark:bg-withe dark:border-slate-900 dark:text-slate-800 dark:placeholder:text-slate-400"
            ...
            <label class="flex flex-col">
                <span class="font-serif text-slate-600 dark:text-slate-800">Password</span>
                <input
                    class="rounded-md shadow-sm border-slate-300 dark:bg-withe text-slate-600 dark:text-slate-400 focus:ring focus:ring-slate-300 dark:focus:ring-slate-800 focus:ring-opacity-50 dark:focus:border-slate-700 focus:border-slate-300 dark:bg-withe dark:border-slate-900 dark:text-slate-800 dark:placeholder:text-slate-400"
            ...
            <label class="flex flex-col">
                <span class="font-serif text-slate-600 dark:text-slate-800">Password Confirmation</span>
                <input
                    class="rounded-md shadow-sm border-slate-300 dark:bg-withe text-slate-600 dark:text-slate-400 focus:ring focus:ring-slate-300 dark:focus:ring-slate-800 focus:ring-opacity-50 dark:focus:border-slate-700 focus:border-slate-300 dark:bg-withe dark:border-slate-900 dark:text-slate-800 dark:placeholder:text-slate-400"
